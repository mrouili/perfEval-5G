...
* [2.1 OAI CN5G pre-requisites](#OAICN5Gpre-requisites)
* [2.2 OAI CN5G configuration files](#OAICN5Gconfigurationfiles)
* [2.3 Pull OAI CN5G docker images](#PullOAICN5Gdockerimages)
* [2.4 Start OAI CN5G](#StartOAICN5G)
* [2.5 Stop OAI CN5G](#StopOAICN5G)
* [2.6 OAI CN5G configuration](#OAICN5Gconfiguration)
* [2.7 Add an ISIM to the OAI CN5G database](#AddanISIMtotheOAICN5Gdatabase)
* [3.1 SIM programming and configuration](#SIMprogrammingandconfiguration)
* [3.2 SUPI concealment](#SUPIconcealment)
* [4.1 Build UHD from source](#BuildUHDfromsource)
* [4.2 USRP x310 Setup](#USRPx310Setup)
	* [4.2.1 Prerequisites](#Prerequisites)
	* [4.2.2 Check Python installation](#CheckPythoninstallation)
	* [4.2.3 Configure firewall to allow communication with USRP](#ConfigurefirewalltoallowcommunicationwithUSRP)
* [4.3 Installing GNUradio from source (Optional/not required for OAI)](#InstallingGNUradiofromsourceOptionalnotrequiredforOAI)
	* [4.3.1. Enabling python support for GNUradio](#EnablingpythonsupportforGNUradio)
* [4.4 Starting and testing the USRP](#StartingandtestingtheUSRP)
* [5.1 Build OAI gNB](#BuildOAIgNB)
* [5.2 OAI gNB configuration](#OAIgNBconfiguration)
* [7.1 Run OAI CN5G](#RunOAICN5G)
* [7.2 Run OAI gNB](#RunOAIgNB)
	* [7.2.1 USRP X310](#USRPX310)
	* [7.2.2 RFSIMULATOR](#RFSIMULATOR)
* [7.3 Connect COTS UE](#ConnectCOTSUE)
* [8.1 Debugging UHD](#DebuggingUHD)
* [8.2 Network not visible on the UE](#NetworknotvisibleontheUE)
* [8.3 No internet on UE (masq does not work)](#NointernetonUEmasqdoesnotwork)
* [8.4 USRP N300 and X300 Ethernet Tuning](#USRPN300andX300EthernetTuning)
* [Authors](#Authors)
* [License](#License)
